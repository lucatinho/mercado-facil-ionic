...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-list-list-module"], {
  ...
  function srcAppPagesListListModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_explore_container_explore_container_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
  ...
  function srcAppPagesListListPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ListPage = /*#__PURE__*/function () {
      function ListPage(menuCtrl) {
        _classCallCheck(this, ListPage);

        this.menuCtrl = menuCtrl; // variavel menu
      ...
      _createClass(ListPage, [{
        ...
        value: function banco() {
          ...
          fetch('./assets/server/mercadosprod.json').then(function (res) {
            return res.json();
          }).then(function (json) {
            console.log('server::', json);
            _this.server = json;
            _this.subitem = _this.server[_this.mercadoSelecionado].children;
            _this.subsubitem = _this.server[_this.mercadoSelecionado].children[_this.categoriaSelecionado].children;
          });
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["MenuController"]])], ListPage);
    /***/
  }
}]);
